...
namespace NET_Framework.Controllers
{
    public class AdressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdressId,Street,Number,PostalCode,Location,Country")] Adress adress)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdressId,Street,Number,PostalCode,Location,Country")] Adress adress)
        {
            if (ModelState.IsValid)
            {
